...
// 206
console.log(lab1.questionOne([4, 3, 5]));
// 50
...
// should output 196
console.log(lab1.questionThree("Tater Tot is a corgi."));
// should output 7
console.log(lab1.questionThree("Amanda\n Ly"));
// should output 3
console.log(lab1.questionThree("can't "));
// should output 1
